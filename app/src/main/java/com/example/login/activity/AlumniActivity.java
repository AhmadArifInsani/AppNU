...
public class AlumniActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        models.add(new AlumniModel(R.drawable.person, "Kholisotin, S. Pd. I.", "06 Februari 1972", "kholisotin06@gmail.com", "PAC Sumobito",  "+62-856-4855-1943", "1996-2002"));
        models.add(new AlumniModel(R.drawable.person, "Wakiatur Rochma", "12 Mei 1989", "wakiaturrochma@gmail.com", "PAC Sumobito",  "+62-812-1682-7762", "2010-2012"));
        models.add(new AlumniModel(R.drawable.person, "Munzilah", "15 Januari 1975", "munzilah@gmail.com", "PAC Sumobito", "+62-856-0762-4258", "1994-1996"));
        models.add(new AlumniModel(R.drawable.person, "Imam Hambali", "06 Mei 1972", "imamhambali@gmail.com", "PAC Sumobito", "+62-856-0733-3539", "1994-1996"));
        models.add(new AlumniModel(R.drawable.person, "Muslik", "19 Oktober 1977", "muslik19@gmail.com", "PAC Sumobito", "+62-856-4896-8095", "2000-2003"));
        setRecyclerView();
